...
const InfoProyectoPage: React.FC = () => {
  const { user } = useAuth();
      ...
      <Paper elevation={3} sx={{ p: 4, borderRadius: 3 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 3 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            <FolderOpen size={32} color="#0891b2" />
        ...
        <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
          Selecciona el área que deseas visualizar:
        </Typography>
        ...
        {loading ? (
          ...
          <Box sx={{ bgcolor: '#f0f9ff', p: 4, borderRadius: 2, border: '1px solid #0891b2', textAlign: 'center' }}>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
              Agrega tu primer link de información del proyecto
            </Typography>
            <Button
              variant="contained"
              startIcon={<Plus size={20} />}
        ...
        <DialogContent>
          <Stack spacing={3} sx={{ mt: 2 }}>
            ...
            <TextField
              ...
              placeholder="Descripción del documento o información..."
            />
            ...
            <TextField
              ...
              placeholder="https://..."
              helperText="URL completa del documento o página"
            />
            ...
            <TextField
              ...
              placeholder="Ej: PDF, XLSX, DOC"
              helperText="Opcional: tipo o extensión del archivo"
            />
          </Stack>
        </DialogContent>
